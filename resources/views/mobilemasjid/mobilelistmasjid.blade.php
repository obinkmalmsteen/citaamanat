...
<head>
    ...
    <title>TAMAMA . List Masjid</title>
...
<br>
            ...
            @php
                $tabs = [
                    'terverifikasi' => [
                        'label' => 'Terverifikasi',
                        'status' => 1, // atau 'terverifikasi'
                        'icon' => 'check',
                        'badge' => 'warna-background',
                    ],
                    'menunggu' => [
                        'label' => 'Menunggu',
                        'status' => 0, // atau 'menunggu'
                            ...
                            <ul class="nav nav-tabs row" role="tablist">
                                @foreach ($tabs as $key => $tab)
                                    <li class="nav-item col text-center">
                                        <a class="nav-link @if ($loop->first) active @endif px-4"
                                            data-toggle="tab" href="#{{ $key }}" role="tab">
                                            <i class="material-icons">{{ $tab['icon'] }}</i>
                                            <div class="small mt-1">{{ $tab['label'] }}</div>
                                        </a>
                                    </li>
                                @endforeach
                            </ul>
                        ...
                        <div class="tab-content mt-3">
                            @foreach ($tabs as $key => $tab)
                                <div class="tab-pane fade @if ($loop->first) show active @endif"
                                    ...
                                    <div class="row">
                                        @forelse ($masjid->where('disetujui', $tab['status']) as $item)
                                            <div class="col-12 col-lg-6">
                                                <div class="card shadow-sm border-0 mb-4">
                                                    <div class="card-body position-relative">

                                                        <p class="text-dark mb-1 h6">
                                                            {{ $item->nama_masjid }}
                                                        </p>
                                                        ...
                                                        <strong>{{ $item->nama_kota }}</strong>

                                                        <span class="badge {{ $tab['badge'] }} position-absolute"
    ...
    <div class="footer">
            <nav class="navi">
                ...
                <a href="{{ route('mobilelistmasjid') }}" class="navi__link navi__link--active">
                    <i class="material-icons navi__icon--active">mosque</i>
                    <span class="navi__text--active">List Masjid</span>
                </a>

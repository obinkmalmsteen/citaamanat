...
<body class="index-page">
        ...
        <div class="container">
            <nav class="navbar navbar-light navbar-expand-lg py-3 navbar-transparent">
                ...
                <a href="{{ route('landingpage') }}" class="navbar-brand">
                 ...
                 <h3 class="mb-0"> <span><img src="/mosque/img/logoyayasan.png" class="img-fluid flex-shrink-10" alt="" width="80"> </span><span class="text-primary">Cita Amanat Martadiredja</span>   </h3>
                </a>
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="hero-header-inner animated zoomIn">
                        ...
                        <h1 class="display-1 mb-5 text-dark">Cita Amanat Martadiredja</h1>
        ...
        <div class="container py-5">
            <div class="row g-5 mb-5">
                <div class="col-xl-6">
                    <div class="row g-4">
                        <div class="col-6">
                            <img src="/mosque/img/menaralampu.png" class="img-fluid h-100 wow zoomIn"
                ...
                <div class="col-xl-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <p class="pb-4">Sebuah gerakan mengembalikan kejayaan Masjid dan Mushola sebagai pusat dari
                        kegiatan
                    ...
                    <div class="bg-light p-3 mb-4">
                        <div class="row align-items-center justify-content-center">
                            ...
                            <div class="col-6">
                                <p class="mb-0"><i>"Kami Akan Berusaha Untuk Mewujudkan Sarana Ibadah Yang Layak, Nyaman, dan
    ...
    <span 
        ...
        class="purecounter">
                                ...
                                <p class="mb-0 text-center"><b>Masjid Terdaftar Saat ini</b></p>
                            </div>
                        </div>
                    </div>
                    <div class="row g-2">
                        <div class="col-md-6">
                            <p class="mb-2"><i class="fa fa-check text-primary me-3"></i>Pengisian Token Listrik</p>
                            <p class="mb-0"><i class="fa fa-check text-primary me-3"></i>Penyediaan lampu</p>
                        </div>
                        <div class="col-md-6">
                            <p class="mb-2"><i class="fa fa-check text-primary me-3"></i>Pembayaran Pasca Bayar PLN
                            </p>
                            <p class="mb-0"><i class="fa fa-check text-primary me-3"></i>Upgrade Meteran Listrik</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="container text-center bg-success-custom py-5 wow fadeIn" data-wow-delay="0.1s">
                <div class="row g-4 align-items-center">
                    ...
                    <div class="col-lg-7 text-center text-primary">
                        <h2 class="mb-0 text-light">"Penerangan adalah fasilitas penting yang menunjang kenyamanan dan
                            kekhusyukan beribadah di masjid. <br> Cahaya yang menerangi masjid, InsyaAllah menjadi
    ...
    <!-- kolom registrasi  -->
    <div class="container-fluid activities bg-light py-5 wow fadeIn">
        <div class="container py-5">
            ...
            <div class="row g-4"> 
                ...
                <div class="col-lg-6 col-xl-4">
                    ...
                    <div class="activities-item p-4 wow fadeIn" data-wow-delay="0.5s">
                        ...
                        <div class="ms-4">
                            ...
                            <a href="{{ route('registrasi') }}" class="btn btn-primary px-3">Daftar Sekarang</a>
                    ...
                    <div class="activities-item p-4 wow fadeIn" data-wow-delay="0.1s">
                        ...
                        <div class="ms-4">
                            ...
                            <p class="mb-4">Melihat lebih lanjut List Masjid Yang Sudah Mendaftar dan Untuk
                                ...
                                Anda Daftarkan.</p>
                            <a href="{{ route('data.masjid.publik') }}" class="btn btn-primary px-3">Lihat Data Pendaftar</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="activities-item p-4 wow fadeIn" data-wow-delay="0.1s">
                        ...
                        <div class="ms-4">
                            <h4>3. Login</h4>
                            <p class="mb-4">Jika status Pendaftaran telah diverifikasi, maka silahkan login ID dan

...
<body class="index-page">
    ...
    <!-- Hero Start -->
    <div class="container-fluid hero-header-reg">
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
    ...
    <div class="container-fluid contact py-5">
        <div class="container py-5">
            <div class="text-center mx-auto mb-5 wow fadeIn" data-wow-delay="0.1s" style="max-width: 700px;">
                <p class="fs-5 text-uppercase text-primary">Form</p>
                <h1 class="display-7">REGISTRASI</h1>
                <p class="mb-0">Silahkan Isi dengan Lengkap, data masjid Anda</a>.</p>
            </div>
            <div class="row g-4 wow fadeIn bg-transparent p-3 border-start-0" data-wow-delay="0.3s">
                <p class="fs-5 text-uppercase text-primary">Data Pengelola Masjid</p>
                ...
                <div class="col-sm-6 ">
                    <div class="input-group ">
                        ...
                        <input type="text" class="form-control bg-transparent p-3 border-start-0"
                            placeholder="Nama Pengelola Masjid">
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control bg-transparent p-3 border-start-0"
                            placeholder="Nomor telepon Pengelola masjid">
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="input-group ">
                        ...
                        <input type="text" class="form-control bg-transparent p-3 border-start-0"
                            placeholder="Nomor telepon Penerima Informasi">
                    </div>
                </div>

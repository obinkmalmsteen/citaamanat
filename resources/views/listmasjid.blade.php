                ...
                <div class="col-md-6 col-lg-6 col-xl-4">
                    <div class="footer-item mt-5">
                        ...
                        <div class="d-flex flex-column align-items-start">
                            ...
                            <a class="text-light mb-2" href="{{ route('kontakkami') }}"><i class="fa fa-check text-light me-2"></i>Kontak Kami</a>
                            <a class="text-light mb-2" href="{{ route('testimoni') }}"><i class="fa fa-check text-light me-2"></i>Testimonial</a>
                            <a class="text-light mb-2" href="{{ route('listmasjid') }}"><i class="fa fa-check text-primary me-2"></i>List Masjid</a>
